    ...
    jobs:
      - job: BuildArtifact
        steps:
          ...
          - script: |
             npmVersionString=$("require('./package.json').version") 
             echo "$npmVersionString"
            workingDirectory: '$(Build.SourcesDirectory)/'
            displayName: 'Get version number app'

          - script: REACT_APP_VERSION=$npm_package_version 
            displayName: echo REACT_APP_VERSION
