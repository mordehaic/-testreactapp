    ...
    jobs:
      - job: BuildArtifact
        steps:
          ...
          - script: $npmVersionString=$(node -p "require('./package.json').version")
            displayName: 'Set Verion'   

          - script: echo $(npmVersionString)
            displayName: 'Display Verion'     
